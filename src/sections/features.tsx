          ...
          {mapfeature.slice(0, 3).map((item: MapFeature, index: number) => {
            return (
              ...
              >
                ...
                <span className="mb-3 text-purple-500 text-2xl">{<item.icon className={"w-10 h-10 text-purple-500 rounded-full"} />}</span>
          ...
          {mapfeature.slice(3, 5).map((item, index) => {
            return (
              ...
              >
                ...
                <span className="mb-1 text-purple-500 text-2xl">{<item.icon className={"w-10 h-10 text-purple-500 rounded-full"} />}</span>
                <div>
