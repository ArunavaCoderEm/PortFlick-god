      ...
      <section className="min-h-screen bg-gray-950 pt-20 py-10 px-4">
        <div className="text-center mt-10 mb-10">
          ...
          <p className="text-lg text-gray-100 px-20">
            ReviewR is your one-stop platform for generating authentic, real
            reviews for your website with just a few clicks. Enhance your
            credibility and improve user trust in no time.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-950 shadow-lg rounded-lg p-6 mx-4 border border-gray-700">
            ...
            <p className="text-gray-400 mb-6">
              A diverse group of talented professionals dedicated to making an
          ...
          <div className="bg-gray-950 shadow-lg rounded-lg p-6 mx-4 border border-gray-700">
            ...
            <p className="text-gray-400 mb-6 mx-4 text-center">
              Join thousands of satisfied users who trust ReviewR to generate
              reliable reviews, improving their online reputation.
            </p>
          </div>
        </div>
