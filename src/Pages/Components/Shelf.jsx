...
const Shelf = ({ position }) => {
  ...
  if (!geometryRef.current) {
    ...
    const firstRackGeometry = new THREE.BoxGeometry(rackHeight, shelfDepth, shelfWidth);
    ...
    const secondRackGeometry = new THREE.BoxGeometry(rackHeight, shelfDepth, shelfWidth);
    ...
    const thirdRackGeometry = new THREE.BoxGeometry(rackHeight, shelfDepth, shelfWidth);
